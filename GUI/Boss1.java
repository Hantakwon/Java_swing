...
public class Boss1 extends JFrame implements KeyListener{
	...
	private int bossMaxHp=100, bossHp=100;
	...
	public Boss1(Boss boss) {
		...
		try {
			...
			bossJewel = inventoryDAO.getInventoryBossjewel1(1);
		} 
	...
	private void gameOver() {
		if (playerHp <= 0) {
			...
			try {
				playerDAO.updatePlayerHp(1, playerHp);
				inventoryDAO.updateInventoryBossjewel1(1, bossJewel);
			} catch (SQLException e) {
				e.printStackTrace();
			}
			boss.hpRenewal();
